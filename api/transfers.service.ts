...
export class TransfersService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listTransfers(page?: string, perPage?: string, guid?: string, transferType?: string, bankGuid?: string, customerGuid?: string, accountGuid?: string, state?: string, label?: string, createdAtGte?: string, createdAtLt?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<TransferListBankModel>;
    public listTransfers(page?: string, perPage?: string, guid?: string, transferType?: string, bankGuid?: string, customerGuid?: string, accountGuid?: string, state?: string, label?: string, createdAtGte?: string, createdAtLt?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<TransferListBankModel>>;
    public listTransfers(page?: string, perPage?: string, guid?: string, transferType?: string, bankGuid?: string, customerGuid?: string, accountGuid?: string, state?: string, label?: string, createdAtGte?: string, createdAtLt?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<TransferListBankModel>>;
