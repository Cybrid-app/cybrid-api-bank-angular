...
// @ts-ignore
import { PatchTransferBankModel } from '../model/patchTransfer';
// @ts-ignore
...
export class TransfersService {
     ...
     * @param acceptVersion API version; must be 2026-04-01 or later for this operation.
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public cancelTransfer(transferGuid: string, acceptVersion: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<TransferBankModel>;
    public cancelTransfer(transferGuid: string, acceptVersion: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<TransferBankModel>>;
    public cancelTransfer(transferGuid: string, acceptVersion: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<TransferBankModel>>;
    public cancelTransfer(transferGuid: string, acceptVersion: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (transferGuid === null || transferGuid === undefined) {
            throw new Error('Required parameter transferGuid was null or undefined when calling cancelTransfer.');
        }
        if (acceptVersion === null || acceptVersion === undefined) {
            throw new Error('Required parameter acceptVersion was null or undefined when calling cancelTransfer.');
        }

        let localVarHeaders = this.defaultHeaders;
        if (acceptVersion !== undefined && acceptVersion !== null) {
            localVarHeaders = localVarHeaders.set('Accept-Version', String(acceptVersion));
        }
        ...
        return this.httpClient.delete<TransferBankModel>(`${this.configuration.basePath}/api/transfers/${encodeURIComponent(String(transferGuid))}`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateTransfer(transferGuid: string, patchTransferBankModel: PatchTransferBankModel, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<TransferBankModel>;
    public updateTransfer(transferGuid: string, patchTransferBankModel: PatchTransferBankModel, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<TransferBankModel>>;
    public updateTransfer(transferGuid: string, patchTransferBankModel: PatchTransferBankModel, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<TransferBankModel>>;
    public updateTransfer(transferGuid: string, patchTransferBankModel: PatchTransferBankModel, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (transferGuid === null || transferGuid === undefined) {
            throw new Error('Required parameter transferGuid was null or undefined when calling updateTransfer.');
        }
        if (patchTransferBankModel === null || patchTransferBankModel === undefined) {
            throw new Error('Required parameter patchTransferBankModel was null or undefined when calling updateTransfer.');
        }
        ...
        return this.httpClient.patch<TransferBankModel>(`${this.configuration.basePath}/api/transfers/${encodeURIComponent(String(transferGuid))}`,
