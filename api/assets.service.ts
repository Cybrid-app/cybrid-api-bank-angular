...
// @ts-ignore
import { AssetListBankModel } from '../model/assetList';
...
export class AssetsService {
     ...
     */
    public listAssets(page?: string, perPage?: string, code?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<AssetListBankModel>;
    public listAssets(page?: string, perPage?: string, code?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<AssetListBankModel>>;
    public listAssets(page?: string, perPage?: string, code?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<AssetListBankModel>>;
    public listAssets(page?: string, perPage?: string, code?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<AssetListBankModel>(`${this.configuration.basePath}/api/assets`,
            {
