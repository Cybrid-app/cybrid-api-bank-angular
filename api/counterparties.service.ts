...
export class CounterpartiesService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listCounterparties(page?: string, perPage?: string, bankGuid?: string, customerGuid?: string, guid?: string, label?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<CounterpartyListBankModel>;
    public listCounterparties(page?: string, perPage?: string, bankGuid?: string, customerGuid?: string, guid?: string, label?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<CounterpartyListBankModel>>;
    public listCounterparties(page?: string, perPage?: string, bankGuid?: string, customerGuid?: string, guid?: string, label?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<CounterpartyListBankModel>>;
    public listCounterparties(page?: string, perPage?: string, bankGuid?: string, customerGuid?: string, guid?: string, label?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
