...
// @ts-ignore
import { CounterpartyListBankModel } from '../model/counterpartyList';
// @ts-ignore
import { ErrorResponseBankModel } from '../model/errorResponse';
// @ts-ignore
import { PostCounterpartyBankModel } from '../model/postCounterparty';
...
export class CounterpartiesService {
     ...
     */
    public createCounterparty(postCounterpartyBankModel: PostCounterpartyBankModel, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<CounterpartyBankModel>;
    public createCounterparty(postCounterpartyBankModel: PostCounterpartyBankModel, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<CounterpartyBankModel>>;
    public createCounterparty(postCounterpartyBankModel: PostCounterpartyBankModel, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<CounterpartyBankModel>>;
    public createCounterparty(postCounterpartyBankModel: PostCounterpartyBankModel, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (postCounterpartyBankModel === null || postCounterpartyBankModel === undefined) {
            throw new Error('Required parameter postCounterpartyBankModel was null or undefined when calling createCounterparty.');
        }
        ...
        return this.httpClient.post<CounterpartyBankModel>(`${this.configuration.basePath}/api/counterparties`,
     ...
     * @param includePii Include PII in the response (requires **counterparties:pii:read** scope).
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public getCounterparty(counterpartyGuid: string, includePii?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<CounterpartyBankModel>;
    public getCounterparty(counterpartyGuid: string, includePii?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<CounterpartyBankModel>>;
    public getCounterparty(counterpartyGuid: string, includePii?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<CounterpartyBankModel>>;
    public getCounterparty(counterpartyGuid: string, includePii?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (counterpartyGuid === null || counterpartyGuid === undefined) {
            throw new Error('Required parameter counterpartyGuid was null or undefined when calling getCounterparty.');
        }
        ...
        return this.httpClient.get<CounterpartyBankModel>(`${this.configuration.basePath}/api/counterparties/${encodeURIComponent(String(counterpartyGuid))}`,
            {
                context: localVarHttpContext,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listCounterparties(page?: string, perPage?: string, type?: string, bankGuid?: string, customerGuid?: string, guid?: string, label?: string, includePii?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<CounterpartyListBankModel>;
    public listCounterparties(page?: string, perPage?: string, type?: string, bankGuid?: string, customerGuid?: string, guid?: string, label?: string, includePii?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<CounterpartyListBankModel>>;
    public listCounterparties(page?: string, perPage?: string, type?: string, bankGuid?: string, customerGuid?: string, guid?: string, label?: string, includePii?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<CounterpartyListBankModel>>;
    public listCounterparties(page?: string, perPage?: string, type?: string, bankGuid?: string, customerGuid?: string, guid?: string, label?: string, includePii?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<CounterpartyListBankModel>(`${this.configuration.basePath}/api/counterparties`,
            {
                context: localVarHttpContext,
                params: localVarQueryParameters,
                responseType: <any>responseType_,
