 ...
 *
 * The version of the OpenAPI document: v0.73.40
...
// @ts-ignore
import { PostRewardBankModel } from '../model/postReward';
// @ts-ignore
import { RewardBankModel } from '../model/reward';
// @ts-ignore
import { RewardListBankModel } from '../model/rewardList';
...
export class RewardsService {
     ...
     */
    public createRewards(postRewardBankModel: PostRewardBankModel, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<RewardBankModel>;
    public createRewards(postRewardBankModel: PostRewardBankModel, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<RewardBankModel>>;
    public createRewards(postRewardBankModel: PostRewardBankModel, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<RewardBankModel>>;
    public createRewards(postRewardBankModel: PostRewardBankModel, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (postRewardBankModel === null || postRewardBankModel === undefined) {
            throw new Error('Required parameter postRewardBankModel was null or undefined when calling createRewards.');
        }
        ...
        return this.httpClient.post<RewardBankModel>(`${this.configuration.basePath}/api/rewards`,
            postRewardBankModel,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getReward(rewardGuid: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<RewardBankModel>;
    public getReward(rewardGuid: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<RewardBankModel>>;
    public getReward(rewardGuid: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<RewardBankModel>>;
    public getReward(rewardGuid: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (rewardGuid === null || rewardGuid === undefined) {
            throw new Error('Required parameter rewardGuid was null or undefined when calling getReward.');
        }
        ...
        return this.httpClient.get<RewardBankModel>(`${this.configuration.basePath}/api/rewards/${encodeURIComponent(String(rewardGuid))}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listRewards(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<RewardListBankModel>;
    public listRewards(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<RewardListBankModel>>;
    public listRewards(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<RewardListBankModel>>;
    public listRewards(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<RewardListBankModel>(`${this.configuration.basePath}/api/rewards`,
            {
                context: localVarHttpContext,
