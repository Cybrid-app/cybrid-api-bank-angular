...
// @ts-ignore
import { FeeConfigurationBankModel } from '../model/feeConfiguration';
// @ts-ignore
import { FeeConfigurationListBankModel } from '../model/feeConfigurationList';
// @ts-ignore
import { PostFeeConfigurationBankModel } from '../model/postFeeConfiguration';
...
export class FeeConfigurationsService {
     ...
     */
    public createFeeConfiguration(postFeeConfigurationBankModel: PostFeeConfigurationBankModel, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<FeeConfigurationBankModel>;
    public createFeeConfiguration(postFeeConfigurationBankModel: PostFeeConfigurationBankModel, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<FeeConfigurationBankModel>>;
    public createFeeConfiguration(postFeeConfigurationBankModel: PostFeeConfigurationBankModel, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<FeeConfigurationBankModel>>;
    public createFeeConfiguration(postFeeConfigurationBankModel: PostFeeConfigurationBankModel, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (postFeeConfigurationBankModel === null || postFeeConfigurationBankModel === undefined) {
            throw new Error('Required parameter postFeeConfigurationBankModel was null or undefined when calling createFeeConfiguration.');
        }
        ...
        return this.httpClient.post<FeeConfigurationBankModel>(`${this.configuration.basePath}/api/fee_configurations`,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getFeeConfiguration(feeConfigurationGuid: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<FeeConfigurationBankModel>;
    public getFeeConfiguration(feeConfigurationGuid: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<FeeConfigurationBankModel>>;
    public getFeeConfiguration(feeConfigurationGuid: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<FeeConfigurationBankModel>>;
    public getFeeConfiguration(feeConfigurationGuid: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (feeConfigurationGuid === null || feeConfigurationGuid === undefined) {
            throw new Error('Required parameter feeConfigurationGuid was null or undefined when calling getFeeConfiguration.');
        }
        ...
        return this.httpClient.get<FeeConfigurationBankModel>(`${this.configuration.basePath}/api/fee_configurations/${encodeURIComponent(String(feeConfigurationGuid))}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listFeeConfigurations(page?: string, perPage?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<FeeConfigurationListBankModel>;
    public listFeeConfigurations(page?: string, perPage?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<FeeConfigurationListBankModel>>;
    public listFeeConfigurations(page?: string, perPage?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<FeeConfigurationListBankModel>>;
    public listFeeConfigurations(page?: string, perPage?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<FeeConfigurationListBankModel>(`${this.configuration.basePath}/api/fee_configurations`,
            {
                context: localVarHttpContext,
