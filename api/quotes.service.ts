...
export class QuotesService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listQuotes(page?: string, perPage?: string, guid?: string, productType?: string, bankGuid?: string, customerGuid?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<QuoteListBankModel>;
    public listQuotes(page?: string, perPage?: string, guid?: string, productType?: string, bankGuid?: string, customerGuid?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<QuoteListBankModel>>;
    public listQuotes(page?: string, perPage?: string, guid?: string, productType?: string, bankGuid?: string, customerGuid?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<QuoteListBankModel>>;
    public listQuotes(page?: string, perPage?: string, guid?: string, productType?: string, bankGuid?: string, customerGuid?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
