...
// @ts-ignore
import { SymbolPriceBankModel } from '../model/symbolPrice';
...
export class PricesService {
     ...
     */
    public listPrices(symbol?: string, tradingSymbol?: string, payoutSymbol?: string, payoutCountryCode?: string, payoutParticipantsType?: string, payoutRoute?: string, bankGuid?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<Array<SymbolPriceBankModel>>;
    public listPrices(symbol?: string, tradingSymbol?: string, payoutSymbol?: string, payoutCountryCode?: string, payoutParticipantsType?: string, payoutRoute?: string, bankGuid?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<Array<SymbolPriceBankModel>>>;
    public listPrices(symbol?: string, tradingSymbol?: string, payoutSymbol?: string, payoutCountryCode?: string, payoutParticipantsType?: string, payoutRoute?: string, bankGuid?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<Array<SymbolPriceBankModel>>>;
    public listPrices(symbol?: string, tradingSymbol?: string, payoutSymbol?: string, payoutCountryCode?: string, payoutParticipantsType?: string, payoutRoute?: string, bankGuid?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        if (tradingSymbol !== undefined && tradingSymbol !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>tradingSymbol, 'trading_symbol');
        }
        if (payoutSymbol !== undefined && payoutSymbol !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>payoutSymbol, 'payout_symbol');
        }
        if (payoutCountryCode !== undefined && payoutCountryCode !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>payoutCountryCode, 'payout_country_code');
        }
        if (payoutParticipantsType !== undefined && payoutParticipantsType !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>payoutParticipantsType, 'payout_participants_type');
        }
        if (payoutRoute !== undefined && payoutRoute !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>payoutRoute, 'payout_route');
        }
        ...
        return this.httpClient.get<Array<SymbolPriceBankModel>>(`${this.configuration.basePath}/api/prices`,
            {
