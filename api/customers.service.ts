...
// @ts-ignore
import { PatchCustomerBankModel } from '../model/patchCustomer';
// @ts-ignore
...
export class CustomersService {
     ...
     * @param includePii Include PII in the response (requires **customers:pii:read** scope).
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public getCustomer(customerGuid: string, includePii?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<CustomerBankModel>;
    public getCustomer(customerGuid: string, includePii?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<CustomerBankModel>>;
    public getCustomer(customerGuid: string, includePii?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<CustomerBankModel>>;
    public getCustomer(customerGuid: string, includePii?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listCustomers(page?: string, perPage?: string, type?: string, bankGuid?: string, guid?: string, label?: string, includePii?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<CustomerListBankModel>;
    public listCustomers(page?: string, perPage?: string, type?: string, bankGuid?: string, guid?: string, label?: string, includePii?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<CustomerListBankModel>>;
    public listCustomers(page?: string, perPage?: string, type?: string, bankGuid?: string, guid?: string, label?: string, includePii?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<CustomerListBankModel>>;
    public listCustomers(page?: string, perPage?: string, type?: string, bankGuid?: string, guid?: string, label?: string, includePii?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public updateCustomer(customerGuid: string, patchCustomerBankModel: PatchCustomerBankModel, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<CustomerBankModel>;
    public updateCustomer(customerGuid: string, patchCustomerBankModel: PatchCustomerBankModel, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<CustomerBankModel>>;
    public updateCustomer(customerGuid: string, patchCustomerBankModel: PatchCustomerBankModel, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<CustomerBankModel>>;
    public updateCustomer(customerGuid: string, patchCustomerBankModel: PatchCustomerBankModel, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (customerGuid === null || customerGuid === undefined) {
            throw new Error('Required parameter customerGuid was null or undefined when calling updateCustomer.');
        }
        if (patchCustomerBankModel === null || patchCustomerBankModel === undefined) {
            throw new Error('Required parameter patchCustomerBankModel was null or undefined when calling updateCustomer.');
        }
        ...
        return this.httpClient.patch<CustomerBankModel>(`${this.configuration.basePath}/api/customers/${encodeURIComponent(String(customerGuid))}`,
