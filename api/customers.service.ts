...
export class CustomersService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listCustomers(page?: string, perPage?: string, bankGuid?: string, guid?: string, label?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<CustomerListBankModel>;
    public listCustomers(page?: string, perPage?: string, bankGuid?: string, guid?: string, label?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<CustomerListBankModel>>;
    public listCustomers(page?: string, perPage?: string, bankGuid?: string, guid?: string, label?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<CustomerListBankModel>>;
    public listCustomers(page?: string, perPage?: string, bankGuid?: string, guid?: string, label?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
