...
export class InvoicesService {
     ...
     */
    public cancelInvoice(invoiceGuid: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<InvoiceBankModel>;
    public cancelInvoice(invoiceGuid: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<InvoiceBankModel>>;
    public cancelInvoice(invoiceGuid: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<InvoiceBankModel>>;
    public cancelInvoice(invoiceGuid: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (invoiceGuid === null || invoiceGuid === undefined) {
            throw new Error('Required parameter invoiceGuid was null or undefined when calling cancelInvoice.');
        }
        ...
        return this.httpClient.delete<InvoiceBankModel>(`${this.configuration.basePath}/api/invoices/${encodeURIComponent(String(invoiceGuid))}`,
            {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listInvoices(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, accountGuid?: string, state?: string, asset?: string, environment?: 'sandbox' | 'production', label?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<InvoiceListBankModel>;
    public listInvoices(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, accountGuid?: string, state?: string, asset?: string, environment?: 'sandbox' | 'production', label?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<InvoiceListBankModel>>;
    public listInvoices(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, accountGuid?: string, state?: string, asset?: string, environment?: 'sandbox' | 'production', label?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<InvoiceListBankModel>>;
    public listInvoices(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, accountGuid?: string, state?: string, asset?: string, environment?: 'sandbox' | 'production', label?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
