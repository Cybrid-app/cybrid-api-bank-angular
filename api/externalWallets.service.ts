...
// @ts-ignore
import { PatchExternalWalletBankModel } from '../model/patchExternalWallet';
// @ts-ignore
...
export class ExternalWalletsService {
     ...
     * @param counterpartyGuid Comma separated counterparty_guids to list external_wallets for.
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listExternalWallets(page?: string, perPage?: string, owner?: string, guid?: string, bankGuid?: string, customerGuid?: string, counterpartyGuid?: string, asset?: string, state?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<ExternalWalletListBankModel>;
    public listExternalWallets(page?: string, perPage?: string, owner?: string, guid?: string, bankGuid?: string, customerGuid?: string, counterpartyGuid?: string, asset?: string, state?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<ExternalWalletListBankModel>>;
    public listExternalWallets(page?: string, perPage?: string, owner?: string, guid?: string, bankGuid?: string, customerGuid?: string, counterpartyGuid?: string, asset?: string, state?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<ExternalWalletListBankModel>>;
    public listExternalWallets(page?: string, perPage?: string, owner?: string, guid?: string, bankGuid?: string, customerGuid?: string, counterpartyGuid?: string, asset?: string, state?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        if (counterpartyGuid !== undefined && counterpartyGuid !== null) {
          localVarQueryParameters = this.addToHttpParams(localVarQueryParameters,
            <any>counterpartyGuid, 'counterparty_guid');
        }
     ...
     * @param externalWalletGuid Identifier for the external_wallet.
     * @param patchExternalWalletBankModel 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public updateExternalWallet(externalWalletGuid: string, patchExternalWalletBankModel: PatchExternalWalletBankModel, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<ExternalWalletBankModel>;
    public updateExternalWallet(externalWalletGuid: string, patchExternalWalletBankModel: PatchExternalWalletBankModel, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<ExternalWalletBankModel>>;
    public updateExternalWallet(externalWalletGuid: string, patchExternalWalletBankModel: PatchExternalWalletBankModel, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<ExternalWalletBankModel>>;
    public updateExternalWallet(externalWalletGuid: string, patchExternalWalletBankModel: PatchExternalWalletBankModel, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (externalWalletGuid === null || externalWalletGuid === undefined) {
            throw new Error('Required parameter externalWalletGuid was null or undefined when calling updateExternalWallet.');
        }
        if (patchExternalWalletBankModel === null || patchExternalWalletBankModel === undefined) {
            throw new Error('Required parameter patchExternalWalletBankModel was null or undefined when calling updateExternalWallet.');
        }
        ...
        return this.httpClient.patch<ExternalWalletBankModel>(`${this.configuration.basePath}/api/external_wallets/${encodeURIComponent(String(externalWalletGuid))}`,
            patchExternalWalletBankModel,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
