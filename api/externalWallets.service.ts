...
export class ExternalWalletsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listExternalWallets(page?: string, perPage?: string, owner?: ListRequestOwnerBankModel, guid?: string, bankGuid?: string, customerGuid?: string, state?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<ExternalWalletListBankModel>;
    public listExternalWallets(page?: string, perPage?: string, owner?: ListRequestOwnerBankModel, guid?: string, bankGuid?: string, customerGuid?: string, state?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<ExternalWalletListBankModel>>;
    public listExternalWallets(page?: string, perPage?: string, owner?: ListRequestOwnerBankModel, guid?: string, bankGuid?: string, customerGuid?: string, state?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<ExternalWalletListBankModel>>;
    public listExternalWallets(page?: string, perPage?: string, owner?: ListRequestOwnerBankModel, guid?: string, bankGuid?: string, customerGuid?: string, state?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
