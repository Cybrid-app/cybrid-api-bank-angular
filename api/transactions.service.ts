...
export class TransactionsService {
     ...
     * @param accountGuid 
     * @param bankGuid Comma separated bank_guids the account must belong to.
     * @param customerGuid Comma separated customer_guids the account must belong to.
     * @param cursor 
     * @param perPage 
     * @param direction 
     ...
     */
    public listTransactions(accountGuid: string, bankGuid?: string, customerGuid?: string, cursor?: string, perPage?: string, direction?: 'credit' | 'debit', createdAtGte?: string, createdAtLt?: string, includeBalances?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<TransactionListBankModel>;
    ...
    public listTransactions(accountGuid: string, bankGuid?: string, customerGuid?: string, cursor?: string, perPage?: string, direction?: 'credit' | 'debit', createdAtGte?: string, createdAtLt?: string, includeBalances?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
