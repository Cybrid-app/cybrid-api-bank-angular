...
// @ts-ignore
import { TransactionListBankModel } from '../model/transactionList';
...
export class TransactionsService {
     ...
     * @param includeBalances Include the running posted balance on the account as of each transaction.
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public listTransactions(accountGuid: string, cursor?: string, perPage?: string, direction?: 'credit' | 'debit', createdAtGte?: string, createdAtLt?: string, includeBalances?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<TransactionListBankModel>;
    public listTransactions(accountGuid: string, cursor?: string, perPage?: string, direction?: 'credit' | 'debit', createdAtGte?: string, createdAtLt?: string, includeBalances?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<TransactionListBankModel>>;
    public listTransactions(accountGuid: string, cursor?: string, perPage?: string, direction?: 'credit' | 'debit', createdAtGte?: string, createdAtLt?: string, includeBalances?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<TransactionListBankModel>>;
    public listTransactions(accountGuid: string, cursor?: string, perPage?: string, direction?: 'credit' | 'debit', createdAtGte?: string, createdAtLt?: string, includeBalances?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (accountGuid === null || accountGuid === undefined) {
            throw new Error('Required parameter accountGuid was null or undefined when calling listTransactions.');
        }
        ...
        return this.httpClient.get<TransactionListBankModel>(`${this.configuration.basePath}/api/transactions`,
            {
