...
export class BanksService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listBanks(page?: number, perPage?: number, guid?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<BankListBankModel>;
    public listBanks(page?: number, perPage?: number, guid?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<BankListBankModel>>;
    public listBanks(page?: number, perPage?: number, guid?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<BankListBankModel>>;
    public listBanks(page?: number, perPage?: number, guid?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
