...
// @ts-ignore
import { PatchAccountBankModel } from '../model/patchAccount';
// @ts-ignore
...
export class AccountsService {
     ...
     * @param includeBalances Whether to include account balances in the response.
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public getAccount(accountGuid: string, includeBalances?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<AccountBankModel>;
    public getAccount(accountGuid: string, includeBalances?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<AccountBankModel>>;
    public getAccount(accountGuid: string, includeBalances?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<AccountBankModel>>;
    public getAccount(accountGuid: string, includeBalances?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listAccounts(page?: string, perPage?: string, owner?: string, guid?: string, type?: string, bankGuid?: string, customerGuid?: string, label?: string, includeBalances?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<AccountListBankModel>;
    public listAccounts(page?: string, perPage?: string, owner?: string, guid?: string, type?: string, bankGuid?: string, customerGuid?: string, label?: string, includeBalances?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<AccountListBankModel>>;
    public listAccounts(page?: string, perPage?: string, owner?: string, guid?: string, type?: string, bankGuid?: string, customerGuid?: string, label?: string, includeBalances?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<AccountListBankModel>>;
    public listAccounts(page?: string, perPage?: string, owner?: string, guid?: string, type?: string, bankGuid?: string, customerGuid?: string, label?: string, includeBalances?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
     ...
     * @param accountGuid Identifier for the account.
     * @param patchAccountBankModel 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public updateAccount(accountGuid: string, patchAccountBankModel: PatchAccountBankModel, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<AccountBankModel>;
    public updateAccount(accountGuid: string, patchAccountBankModel: PatchAccountBankModel, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<AccountBankModel>>;
    public updateAccount(accountGuid: string, patchAccountBankModel: PatchAccountBankModel, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<AccountBankModel>>;
    public updateAccount(accountGuid: string, patchAccountBankModel: PatchAccountBankModel, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (accountGuid === null || accountGuid === undefined) {
            throw new Error('Required parameter accountGuid was null or undefined when calling updateAccount.');
        }
        if (patchAccountBankModel === null || patchAccountBankModel === undefined) {
            throw new Error('Required parameter patchAccountBankModel was null or undefined when calling updateAccount.');
        }
        ...
        return this.httpClient.patch<AccountBankModel>(`${this.configuration.basePath}/api/accounts/${encodeURIComponent(String(accountGuid))}`,
            patchAccountBankModel,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
