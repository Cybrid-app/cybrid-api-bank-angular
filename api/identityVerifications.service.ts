...
export class IdentityVerificationsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getIdentityVerification(identityVerificationGuid: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<IdentityVerificationWithDetailsBankModel>;
    public getIdentityVerification(identityVerificationGuid: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<IdentityVerificationWithDetailsBankModel>>;
    public getIdentityVerification(identityVerificationGuid: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<IdentityVerificationWithDetailsBankModel>>;
