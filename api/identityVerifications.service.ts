...
// @ts-ignore
import { IdentityVerificationWithDetailsBankModel } from '../model/identityVerificationWithDetails';
// @ts-ignore
...
export class IdentityVerificationsService {
     ...
     * @param includePii Include PII in the response (requires **identity_verifications:pii:read** scope).
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public getIdentityVerification(identityVerificationGuid: string, includePii?: boolean, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<IdentityVerificationWithDetailsBankModel>;
    public getIdentityVerification(identityVerificationGuid: string, includePii?: boolean, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<IdentityVerificationWithDetailsBankModel>>;
    public getIdentityVerification(identityVerificationGuid: string, includePii?: boolean, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<IdentityVerificationWithDetailsBankModel>>;
    public getIdentityVerification(identityVerificationGuid: string, includePii?: boolean, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<IdentityVerificationWithDetailsBankModel>(`${this.configuration.basePath}/api/identity_verifications/${encodeURIComponent(String(identityVerificationGuid))}`,
            {
                context: localVarHttpContext,
     ...
     * @param counterpartyGuid Comma separated counterparty_guids to list identity verifications for.
     ...
     * @param method Comma separated methods to list identity verifications for.
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public listIdentityVerifications(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, counterpartyGuid?: string, state?: string, type?: string, method?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<IdentityVerificationListBankModel>;
    public listIdentityVerifications(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, counterpartyGuid?: string, state?: string, type?: string, method?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<IdentityVerificationListBankModel>>;
    public listIdentityVerifications(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, counterpartyGuid?: string, state?: string, type?: string, method?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<IdentityVerificationListBankModel>>;
    public listIdentityVerifications(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, counterpartyGuid?: string, state?: string, type?: string, method?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
