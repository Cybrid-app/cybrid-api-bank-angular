...
export class DepositBankAccountsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listDepositBankAccounts(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, label?: string, uniqueMemoId?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<DepositBankAccountListBankModel>;
    public listDepositBankAccounts(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, label?: string, uniqueMemoId?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<DepositBankAccountListBankModel>>;
    public listDepositBankAccounts(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, label?: string, uniqueMemoId?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<DepositBankAccountListBankModel>>;
    public listDepositBankAccounts(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, label?: string, uniqueMemoId?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
