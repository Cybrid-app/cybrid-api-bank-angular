...
// @ts-ignore
import { PatchDepositBankAccountBankModel } from '../model/patchDepositBankAccount';
// @ts-ignore
...
export class DepositBankAccountsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public deleteDepositBankAccount(depositBankAccountGuid: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<DepositBankAccountBankModel>;
    public deleteDepositBankAccount(depositBankAccountGuid: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<DepositBankAccountBankModel>>;
    public deleteDepositBankAccount(depositBankAccountGuid: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<DepositBankAccountBankModel>>;
    public deleteDepositBankAccount(depositBankAccountGuid: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (depositBankAccountGuid === null || depositBankAccountGuid === undefined) {
            throw new Error('Required parameter depositBankAccountGuid was null or undefined when calling deleteDepositBankAccount.');
        }
        ...
        return this.httpClient.delete<DepositBankAccountBankModel>(`${this.configuration.basePath}/api/deposit_bank_accounts/${encodeURIComponent(String(depositBankAccountGuid))}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param state Comma separated states to list deposit bank accounts for.
     * @param parentDepositBankAccountGuid Comma separated guids for parent accounts to list deposit bank accounts for.
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public listDepositBankAccounts(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, label?: string, uniqueMemoId?: string, type?: string, state?: string, parentDepositBankAccountGuid?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<DepositBankAccountListBankModel>;
     ...
     * @param depositBankAccountGuid Identifier for the deposit bank account.
     * @param patchDepositBankAccountBankModel 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public updateDepositBankAccount(depositBankAccountGuid: string, patchDepositBankAccountBankModel: PatchDepositBankAccountBankModel, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<DepositBankAccountBankModel>;
    public updateDepositBankAccount(depositBankAccountGuid: string, patchDepositBankAccountBankModel: PatchDepositBankAccountBankModel, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<DepositBankAccountBankModel>>;
    public updateDepositBankAccount(depositBankAccountGuid: string, patchDepositBankAccountBankModel: PatchDepositBankAccountBankModel, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<DepositBankAccountBankModel>>;
    public updateDepositBankAccount(depositBankAccountGuid: string, patchDepositBankAccountBankModel: PatchDepositBankAccountBankModel, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (depositBankAccountGuid === null || depositBankAccountGuid === undefined) {
            throw new Error('Required parameter depositBankAccountGuid was null or undefined when calling updateDepositBankAccount.');
        }
        if (patchDepositBankAccountBankModel === null || patchDepositBankAccountBankModel === undefined) {
            throw new Error('Required parameter patchDepositBankAccountBankModel was null or undefined when calling updateDepositBankAccount.');
        }
        ...
        return this.httpClient.patch<DepositBankAccountBankModel>(`${this.configuration.basePath}/api/deposit_bank_accounts/${encodeURIComponent(String(depositBankAccountGuid))}`,
