...
// @ts-ignore
import { PatchDepositAddressBankModel } from '../model/patchDepositAddress';
// @ts-ignore
...
export class DepositAddressesService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listDepositAddresses(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, label?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<DepositAddressListBankModel>;
    public listDepositAddresses(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, label?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<DepositAddressListBankModel>>;
    public listDepositAddresses(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, label?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<DepositAddressListBankModel>>;
    public listDepositAddresses(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, label?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
     ...
     * @param depositAddressGuid Identifier for the deposit address.
     * @param patchDepositAddressBankModel 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public updateDepositAddress(depositAddressGuid: string, patchDepositAddressBankModel: PatchDepositAddressBankModel, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<DepositAddressBankModel>;
    public updateDepositAddress(depositAddressGuid: string, patchDepositAddressBankModel: PatchDepositAddressBankModel, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<DepositAddressBankModel>>;
    public updateDepositAddress(depositAddressGuid: string, patchDepositAddressBankModel: PatchDepositAddressBankModel, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<DepositAddressBankModel>>;
    public updateDepositAddress(depositAddressGuid: string, patchDepositAddressBankModel: PatchDepositAddressBankModel, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (depositAddressGuid === null || depositAddressGuid === undefined) {
            throw new Error('Required parameter depositAddressGuid was null or undefined when calling updateDepositAddress.');
        }
        if (patchDepositAddressBankModel === null || patchDepositAddressBankModel === undefined) {
            throw new Error('Required parameter patchDepositAddressBankModel was null or undefined when calling updateDepositAddress.');
        }
        ...
        return this.httpClient.patch<DepositAddressBankModel>(`${this.configuration.basePath}/api/deposit_addresses/${encodeURIComponent(String(depositAddressGuid))}`,
            patchDepositAddressBankModel,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
