...
// @ts-ignore
import { PersonaSessionBankModel } from '../model/personaSession';
// @ts-ignore
import { PostPersonaSessionBankModel } from '../model/postPersonaSession';
...
export class PersonaSessionsService {
     ...
     */
    public createPersonaSession(postPersonaSessionBankModel: PostPersonaSessionBankModel, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<PersonaSessionBankModel>;
    public createPersonaSession(postPersonaSessionBankModel: PostPersonaSessionBankModel, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<PersonaSessionBankModel>>;
    public createPersonaSession(postPersonaSessionBankModel: PostPersonaSessionBankModel, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<PersonaSessionBankModel>>;
    public createPersonaSession(postPersonaSessionBankModel: PostPersonaSessionBankModel, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (postPersonaSessionBankModel === null || postPersonaSessionBankModel === undefined) {
            throw new Error('Required parameter postPersonaSessionBankModel was null or undefined when calling createPersonaSession.');
        }
        ...
        return this.httpClient.post<PersonaSessionBankModel>(`${this.configuration.basePath}/api/persona_sessions`,
