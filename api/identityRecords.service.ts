...
export class IdentityRecordsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listIdentityRecords(customerGuid?: string, page?: number, perPage?: number, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<IdentityRecordListBankModel>;
    public listIdentityRecords(customerGuid?: string, page?: number, perPage?: number, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<IdentityRecordListBankModel>>;
    public listIdentityRecords(customerGuid?: string, page?: number, perPage?: number, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<IdentityRecordListBankModel>>;
    public listIdentityRecords(customerGuid?: string, page?: number, perPage?: number, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
