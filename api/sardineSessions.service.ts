...
// @ts-ignore
import { PostSardineSessionBankModel } from '../model/postSardineSession';
// @ts-ignore
import { SardineSessionBankModel } from '../model/sardineSession';
...
export class SardineSessionsService {
     ...
     * @param postSardineSessionBankModel 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public createSardineSession(postSardineSessionBankModel: PostSardineSessionBankModel, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<SardineSessionBankModel>;
    public createSardineSession(postSardineSessionBankModel: PostSardineSessionBankModel, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<SardineSessionBankModel>>;
    public createSardineSession(postSardineSessionBankModel: PostSardineSessionBankModel, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<SardineSessionBankModel>>;
    public createSardineSession(postSardineSessionBankModel: PostSardineSessionBankModel, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (postSardineSessionBankModel === null || postSardineSessionBankModel === undefined) {
            throw new Error('Required parameter postSardineSessionBankModel was null or undefined when calling createSardineSession.');
        }
        ...
        return this.httpClient.post<SardineSessionBankModel>(`${this.configuration.basePath}/api/sardine_sessions`,
