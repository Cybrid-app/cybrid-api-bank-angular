...
export class TradingConfigurationsService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listTradingConfigurations(page?: string, perPage?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<TradingConfigurationListBankModel>;
    public listTradingConfigurations(page?: string, perPage?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<TradingConfigurationListBankModel>>;
    public listTradingConfigurations(page?: string, perPage?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<TradingConfigurationListBankModel>>;
    public listTradingConfigurations(page?: string, perPage?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
