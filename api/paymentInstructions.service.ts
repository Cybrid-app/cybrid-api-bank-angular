 ...
 *
 * The version of the OpenAPI document: v0.129.1011
...
// @ts-ignore
import { PaymentInstructionListBankModel } from '../model/paymentInstructionList';
// @ts-ignore
import { PostPaymentInstructionBankModel } from '../model/postPaymentInstruction';
...
export class PaymentInstructionsService {
     ...
     */
    public createPaymentInstruction(postPaymentInstructionBankModel: PostPaymentInstructionBankModel, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<PaymentInstructionBankModel>;
    public createPaymentInstruction(postPaymentInstructionBankModel: PostPaymentInstructionBankModel, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<PaymentInstructionBankModel>>;
    public createPaymentInstruction(postPaymentInstructionBankModel: PostPaymentInstructionBankModel, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<PaymentInstructionBankModel>>;
    public createPaymentInstruction(postPaymentInstructionBankModel: PostPaymentInstructionBankModel, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (postPaymentInstructionBankModel === null || postPaymentInstructionBankModel === undefined) {
            throw new Error('Required parameter postPaymentInstructionBankModel was null or undefined when calling createPaymentInstruction.');
        }
        ...
        return this.httpClient.post<PaymentInstructionBankModel>(`${this.configuration.basePath}/api/payment_instructions`,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public getPaymentInstruction(paymentInstructionGuid: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<PaymentInstructionBankModel>;
    public getPaymentInstruction(paymentInstructionGuid: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<PaymentInstructionBankModel>>;
    public getPaymentInstruction(paymentInstructionGuid: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<PaymentInstructionBankModel>>;
    public getPaymentInstruction(paymentInstructionGuid: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (paymentInstructionGuid === null || paymentInstructionGuid === undefined) {
            throw new Error('Required parameter paymentInstructionGuid was null or undefined when calling getPaymentInstruction.');
        }
        ...
        return this.httpClient.get<PaymentInstructionBankModel>(`${this.configuration.basePath}/api/payment_instructions/${encodeURIComponent(String(paymentInstructionGuid))}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public listPaymentInstructions(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, invoiceGuid?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<PaymentInstructionListBankModel>;
    public listPaymentInstructions(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, invoiceGuid?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<PaymentInstructionListBankModel>>;
    public listPaymentInstructions(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, invoiceGuid?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<PaymentInstructionListBankModel>>;
    public listPaymentInstructions(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, invoiceGuid?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<PaymentInstructionListBankModel>(`${this.configuration.basePath}/api/payment_instructions`,
            {
                context: localVarHttpContext,
