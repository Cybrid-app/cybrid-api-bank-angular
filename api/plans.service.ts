...
// @ts-ignore
import { PlanBankModel } from '../model/plan';
// @ts-ignore
import { PlanListBankModel } from '../model/planList';
// @ts-ignore
import { PostPlanBankModel } from '../model/postPlan';
...
export class PlansService {
     ...
     * @param postPlanBankModel 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public createPlan(postPlanBankModel: PostPlanBankModel, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<PlanBankModel>;
    public createPlan(postPlanBankModel: PostPlanBankModel, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<PlanBankModel>>;
    public createPlan(postPlanBankModel: PostPlanBankModel, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<PlanBankModel>>;
    public createPlan(postPlanBankModel: PostPlanBankModel, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (postPlanBankModel === null || postPlanBankModel === undefined) {
            throw new Error('Required parameter postPlanBankModel was null or undefined when calling createPlan.');
        }
        ...
        return this.httpClient.post<PlanBankModel>(`${this.configuration.basePath}/api/plans`,
            postPlanBankModel,
            {
     ...
     * @param planGuid Identifier for the payment instruction.
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public getPlan(planGuid: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<PlanBankModel>;
    public getPlan(planGuid: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<PlanBankModel>>;
    public getPlan(planGuid: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<PlanBankModel>>;
    public getPlan(planGuid: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        if (planGuid === null || planGuid === undefined) {
            throw new Error('Required parameter planGuid was null or undefined when calling getPlan.');
        }
        ...
        return this.httpClient.get<PlanBankModel>(`${this.configuration.basePath}/api/plans/${encodeURIComponent(String(planGuid))}`,
            {
                context: localVarHttpContext,
                responseType: <any>responseType_,
                withCredentials: this.configuration.withCredentials,
     ...
     * @param guid Comma separated plan_guids to list plans for.
     * @param bankGuid Comma separated bank_guids to list plans for.
     * @param customerGuid Comma separated customer_guids to list plans for.
     * @param type Comma separated types to list plans for.
     * @param state Comma separated states to list plans for.
     * @param sourceAccountGuid Comma separated source account guids to list plans for.
     * @param destinationAccountGuid Comma separated destination account guids to list plans for.
     ...
     * @param label Comma separated labels to list plans for.
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public listPlans(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, type?: string, state?: string, sourceAccountGuid?: string, destinationAccountGuid?: string, createdAtGte?: string, createdAtLt?: string, updatedAtGte?: string, updatedAtLt?: string, label?: string, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<PlanListBankModel>;
    public listPlans(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, type?: string, state?: string, sourceAccountGuid?: string, destinationAccountGuid?: string, createdAtGte?: string, createdAtLt?: string, updatedAtGte?: string, updatedAtLt?: string, label?: string, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpResponse<PlanListBankModel>>;
    public listPlans(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, type?: string, state?: string, sourceAccountGuid?: string, destinationAccountGuid?: string, createdAtGte?: string, createdAtLt?: string, updatedAtGte?: string, updatedAtLt?: string, label?: string, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<HttpEvent<PlanListBankModel>>;
    public listPlans(page?: string, perPage?: string, guid?: string, bankGuid?: string, customerGuid?: string, type?: string, state?: string, sourceAccountGuid?: string, destinationAccountGuid?: string, createdAtGte?: string, createdAtLt?: string, updatedAtGte?: string, updatedAtLt?: string, label?: string, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json', context?: HttpContext}): Observable<any> {
        ...
        return this.httpClient.get<PlanListBankModel>(`${this.configuration.basePath}/api/plans`,
            {
                context: localVarHttpContext,
