...
export namespace TransferBankModel {
    export type TransferTypeEnum = 'funding' | 'book' | 'crypto' | 'instant_funding' | 'funding_return' | 'crypto_return';
    export const TransferTypeEnum = {
        ...
        InstantFunding: 'instant_funding' as TransferTypeEnum,
        FundingReturn: 'funding_return' as TransferTypeEnum,
        CryptoReturn: 'crypto_return' as TransferTypeEnum
    };
    ...
    export type StateEnum = 'storing' | 'pending' | 'reviewing' | 'completed' | 'failed';
    export const StateEnum = {
        Storing: 'storing' as StateEnum,
        Pending: 'pending' as StateEnum,
        Reviewing: 'reviewing' as StateEnum,
