 ...
 */
import { TransferIdentifiersInnerBankModel } from './transferIdentifiersInner';
import { TransferParticipantBankModel } from './transferParticipant';
import { TransferHoldDetailsBankModel } from './transferHoldDetails';
import { FeeDetailBankModel } from './feeDetail';
import { TransferEntryBankModel } from './transferEntry';
...
export interface TransferBankModel { 
    ...
    guid?: string;
    /**
     * The type of transfer; one of funding, book, crypto, instant_funding, funding_return, crypto_return, loss_recovery, inter_account, lightning, instant_funding_return, loss_coverage, or loss_reclaim.
     */
    ...
    /**
     * The fee associated with the transfer. Represents the sum of the bank and platform fees.
     */
    fee?: string;
    /**
     * The fees associated with the transfer.
     */
    fee_details?: Array<FeeDetailBankModel>;
    /**
     ...
     */
    updated_at?: string;
    hold_details?: TransferHoldDetailsBankModel | null;
    /**
     * The raw details on the transfer from the bank.
     */
    transfer_details?: object | null;
    /**
     ...
     */
    entries?: Array<TransferEntryBankModel> | null;
}
