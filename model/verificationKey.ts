...
export interface VerificationKeyBankModel { 
    /**
     ...
     */
    type?: VerificationKeyBankModel.TypeEnum;
    /**
     * The verification key\'s state.
     */
    state?: VerificationKeyBankModel.StateEnum;
    /**
     * The verification key\'s failure code (if any).
     */
    failure_code?: VerificationKeyBankModel.FailureCodeEnum | null;
    /**
     * The verification key\'s algorithm.
     */
    algorithm?: VerificationKeyBankModel.AlgorithmEnum;
    /**
...
export namespace VerificationKeyBankModel {
    export type TypeEnum = 'attestation';
    export const TypeEnum = {
        Attestation: 'attestation' as TypeEnum
    };
    export type StateEnum = 'storing' | 'pending' | 'verified' | 'failed';
    ...
    export type FailureCodeEnum = 'invalid_algorithm' | 'invalid_nonce' | 'invalid_public_key' | 'invalid_signature';
    export const FailureCodeEnum = {
        Algorithm: 'invalid_algorithm' as FailureCodeEnum,
        Nonce: 'invalid_nonce' as FailureCodeEnum,
        PublicKey: 'invalid_public_key' as FailureCodeEnum,
        Signature: 'invalid_signature' as FailureCodeEnum
    };
