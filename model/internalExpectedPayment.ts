...
export interface InternalExpectedPaymentBankModel { 
    /**
     ...
     */
    payment_kind?: InternalExpectedPaymentBankModel.PaymentKindEnum;
    /**
     * The environment that the payment is expected in.
     */
    environment?: InternalExpectedPaymentBankModel.EnvironmentEnum;
    /**
     * The identifier of the exchange settlement obligation that this payment is associated with.
     */
    exchange_settlement_obligation_guid?: string | null;
    /**
     * The identifier of the platform account that this payment is associated with.
     */
    credit_account_guid?: string | null;
    /**
     * The identifier of the settlement account that this payment is made available in.
     */
    settlement_account_guid?: string | null;
    /**
     ...
     */
    internal_account_type?: InternalExpectedPaymentBankModel.InternalAccountTypeEnum;
    /**
     * The exchange settlement expected payment\'s state
     */
    state?: InternalExpectedPaymentBankModel.StateEnum;
    /**
...
export namespace InternalExpectedPaymentBankModel {
    export type PaymentKindEnum = 'gas_payment' | 'gas_settlement' | 'platform_payment' | 'exchange_settlement';
    export const PaymentKindEnum = {
        GasPayment: 'gas_payment' as PaymentKindEnum,
        GasSettlement: 'gas_settlement' as PaymentKindEnum,
        PlatformPayment: 'platform_payment' as PaymentKindEnum,
        ExchangeSettlement: 'exchange_settlement' as PaymentKindEnum
    };
