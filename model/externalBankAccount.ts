...
import { ExternalBankAccountPiiInnerBankModel } from './externalBankAccountPiiInner';
...
export namespace ExternalBankAccountBankModel {
    export type AccountKindEnum = 'plaid' | 'plaid_processor_token' | 'raw_routing_details';
