...
export interface AccountBankModel { 
     ...
     * The account type.
     */
    type?: AccountBankModel.TypeEnum;
    /**
     * The account provider, if applicable.
     */
    provider?: AccountBankModel.ProviderEnum | null;
    /**
     ...
     * The account\'s state.
     */
    state?: AccountBankModel.StateEnum;
}
export namespace AccountBankModel {
    export type TypeEnum = 'backstopped' | 'trading' | 'fee' | 'savings' | 'staking';
    export const TypeEnum = {
        Backstopped: 'backstopped' as TypeEnum,
        Trading: 'trading' as TypeEnum,
        Fee: 'fee' as TypeEnum,
        Savings: 'savings' as TypeEnum,
        Staking: 'staking' as TypeEnum
    };
    export type ProviderEnum = 'compound';
    export const ProviderEnum = {
        Compound: 'compound' as ProviderEnum
    };
