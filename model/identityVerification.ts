...
export interface IdentityVerificationBankModel { 
     ...
     */
    type?: IdentityVerificationBankModel.TypeEnum;
    /**
     * The identity verification method.
     */
    method?: IdentityVerificationBankModel.MethodEnum;
    /**
     ...
     */
    state?: IdentityVerificationBankModel.StateEnum;
    /**
     * The outcome of the verification process.
     */
    outcome?: IdentityVerificationBankModel.OutcomeEnum | null;
    /**
     * The reason codes explaining the outcome.
     */
    failure_codes?: Array<IdentityVerificationBankModel.FailureCodesEnum>;
    /**
     ...
     */
    persona_state?: IdentityVerificationBankModel.PersonaStateEnum | null;
}
export namespace IdentityVerificationBankModel {
    ...
    export type FailureCodesEnum = 'requested_failure';
    export const FailureCodesEnum = {
        RequestedFailure: 'requested_failure' as FailureCodesEnum
    };
    export type PersonaStateEnum = 'waiting' | 'pending' | 'reviewing' | 'expired' | 'completed' | 'unknown';
