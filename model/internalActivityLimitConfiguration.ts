 ...
 */
import { InternalActivityLimitBankModel } from './internalActivityLimit';
...
export interface InternalActivityLimitConfigurationBankModel { 
     ...
     */
    type?: InternalActivityLimitConfigurationBankModel.TypeEnum;
    /**
     * The (optional) activity the configuration is associated with; one of trading, funding, book_transfer, or crypto_transfer.
     */
    activity?: InternalActivityLimitConfigurationBankModel.ActivityEnum | null;
    /**
     * The (optional) side the configuration is associated with; one of deposit or withdrawal.
     */
    side?: InternalActivityLimitConfigurationBankModel.SideEnum | null;
    /**
     * The environment the configuration is associated with.
     */
    environment?: InternalActivityLimitConfigurationBankModel.EnvironmentEnum | null;
    /**
     ...
     * The payment rail.
     */
    audience?: InternalActivityLimitConfigurationBankModel.AudienceEnum | null;
    /**
...
export namespace InternalActivityLimitConfigurationBankModel {
    export type TypeEnum = 'platform' | 'bank' | 'customer';
    export const TypeEnum = {
        Platform: 'platform' as TypeEnum,
        Bank: 'bank' as TypeEnum,
        Customer: 'customer' as TypeEnum
    };
    export type ActivityEnum = 'trading' | 'funding' | 'book_transfer' | 'crypto_transfer';
    export const ActivityEnum = {
        Trading: 'trading' as ActivityEnum,
        Funding: 'funding' as ActivityEnum,
        BookTransfer: 'book_transfer' as ActivityEnum,
        CryptoTransfer: 'crypto_transfer' as ActivityEnum
    };
    ...
    export type AudienceEnum = 'individual_tax_id_verified_customer' | 'individual_tax_id_unverified_customer' | 'business_customer';
    export const AudienceEnum = {
        IndividualTaxIdVerifiedCustomer: 'individual_tax_id_verified_customer' as AudienceEnum,
        IndividualTaxIdUnverifiedCustomer: 'individual_tax_id_unverified_customer' as AudienceEnum,
        BusinessCustomer: 'business_customer' as AudienceEnum
    };
}
