...
export interface InternalTradeBankModel { 
     ...
     * The type of trade.
     */
    trade_type?: InternalTradeBankModel.TradeTypeEnum;
    /**
     ...
     */
    side?: InternalTradeBankModel.SideEnum;
    /**
     * The trade\'s state
     */
    state?: InternalTradeBankModel.StateEnum;
    /**
...
export namespace InternalTradeBankModel {
    export type TradeTypeEnum = 'platform' | 'internal' | 'liquidation' | 'exit';
    export const TradeTypeEnum = {
        Platform: 'platform' as TradeTypeEnum,
        Internal: 'internal' as TradeTypeEnum,
        Liquidation: 'liquidation' as TradeTypeEnum,
        Exit: 'exit' as TradeTypeEnum
    };
    ...
    export type StateEnum = 'storing' | 'pending' | 'cancelled' | 'completed' | 'settling' | 'failed';
