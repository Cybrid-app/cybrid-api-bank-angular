 ...
 */
import { QuoteEntryBankModel } from './quoteEntry';


export interface InternalQuoteBankModel { 
    /**
     ...
     */
    product_type?: InternalQuoteBankModel.ProductTypeEnum;
    /**
     ...
     */
    side?: InternalQuoteBankModel.SideEnum;
    /**
    ...
    /**
     * The entries for the quote.
     */
    entries?: Array<QuoteEntryBankModel> | null;
}
export namespace InternalQuoteBankModel {
    export type ProductTypeEnum = 'trading' | 'trading_exit' | 'trading_liquidation' | 'funding' | 'book_transfer' | 'crypto_transfer' | 'internal_trading' | 'internal_bank_rebalance' | 'internal_wallet_rebalance' | 'loss_recovery_transfer' | 'inter_account' | 'lightning_transfer';
    export const ProductTypeEnum = {
        Trading: 'trading' as ProductTypeEnum,
        TradingExit: 'trading_exit' as ProductTypeEnum,
        TradingLiquidation: 'trading_liquidation' as ProductTypeEnum,
        Funding: 'funding' as ProductTypeEnum,
        BookTransfer: 'book_transfer' as ProductTypeEnum,
        CryptoTransfer: 'crypto_transfer' as ProductTypeEnum,
        InternalTrading: 'internal_trading' as ProductTypeEnum,
        InternalBankRebalance: 'internal_bank_rebalance' as ProductTypeEnum,
        InternalWalletRebalance: 'internal_wallet_rebalance' as ProductTypeEnum,
        LossRecoveryTransfer: 'loss_recovery_transfer' as ProductTypeEnum,
        InterAccount: 'inter_account' as ProductTypeEnum,
        LightningTransfer: 'lightning_transfer' as ProductTypeEnum
    };
