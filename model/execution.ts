 ...
 */
import { HoldDetailBankModel } from './holdDetail';
import { PlanReferenceBankModel } from './planReference';
import { IntermediateAccountBankModel } from './intermediateAccount';
import { AccountAssociationBankModel } from './accountAssociation';
import { ExecutionTravelRuleInfoBankModel } from './executionTravelRuleInfo';
import { FeeAssociationBankModel } from './feeAssociation';
import { EffectiveRateBankModel } from './effectiveRate';
import { StageBankModel } from './stage';


export interface ExecutionBankModel { 
    /**
     * Auto-generated unique identifier for the quote.
     */
    guid: string;
    /**
     * The type of product the plan is for; one of remittance, bill_pay, disbursement, invoice_pay, deposit, withdrawal, conversion, deposit_return, withdrawal_return, or payout_return.
     */
    type: string;
    /**
     ...
     */
    intermediate_accounts?: Array<IntermediateAccountBankModel> | null;
    /**
    ...
    effective_rate?: EffectiveRateBankModel;
    /**
     * The holds placed on the execution.
     */
    holds?: Array<HoldDetailBankModel> | null;
    travel_rule_info: ExecutionTravelRuleInfoBankModel;
    /**
     * The purpose of transaction for the execution.
     */
    purpose_of_transaction?: ExecutionBankModel.PurposeOfTransactionEnum | null;
    /**
     ...
     */
    references?: Array<PlanReferenceBankModel> | null;
    /**
     * The labels associated with the execution.
     */
    labels?: Array<string> | null;
}
export namespace ExecutionBankModel {
    export type PurposeOfTransactionEnum = 'computer_services' | 'family_support' | 'education' | 'gift' | 'charitable_donation' | 'medical_treatment' | 'maintenance_expenses' | 'travel' | 'hotel_accommodation' | 'small_value_remittance' | 'liberalized_remittance' | 'personal_transfer' | 'loan_payment' | 'tax_payment' | 'construction_expenses' | 'advertising_expenses' | 'advisory_fees' | 'business_insurance' | 'insurance_claims' | 'delivery_fees' | 'service_charges' | 'office_expenses' | 'property_purchase' | 'property_rental' | 'royalty_fees' | 'shares_investment' | 'fund_investment' | 'bill_payment' | 'transportation_fees' | 'salary_payment' | 'reward_payment' | 'influencer_payment' | 'other_fees' | 'other' | 'exported_goods' | 'commission_on_goods' | 'commission_on_services' | 'accounting_services' | 'exhibition_services';
    export const PurposeOfTransactionEnum = {
        ComputerServices: 'computer_services' as PurposeOfTransactionEnum,
        FamilySupport: 'family_support' as PurposeOfTransactionEnum,
        Education: 'education' as PurposeOfTransactionEnum,
        Gift: 'gift' as PurposeOfTransactionEnum,
        CharitableDonation: 'charitable_donation' as PurposeOfTransactionEnum,
        MedicalTreatment: 'medical_treatment' as PurposeOfTransactionEnum,
        MaintenanceExpenses: 'maintenance_expenses' as PurposeOfTransactionEnum,
        Travel: 'travel' as PurposeOfTransactionEnum,
        HotelAccommodation: 'hotel_accommodation' as PurposeOfTransactionEnum,
        SmallValueRemittance: 'small_value_remittance' as PurposeOfTransactionEnum,
        LiberalizedRemittance: 'liberalized_remittance' as PurposeOfTransactionEnum,
        PersonalTransfer: 'personal_transfer' as PurposeOfTransactionEnum,
        LoanPayment: 'loan_payment' as PurposeOfTransactionEnum,
        TaxPayment: 'tax_payment' as PurposeOfTransactionEnum,
        ConstructionExpenses: 'construction_expenses' as PurposeOfTransactionEnum,
        AdvertisingExpenses: 'advertising_expenses' as PurposeOfTransactionEnum,
        AdvisoryFees: 'advisory_fees' as PurposeOfTransactionEnum,
        BusinessInsurance: 'business_insurance' as PurposeOfTransactionEnum,
        InsuranceClaims: 'insurance_claims' as PurposeOfTransactionEnum,
        DeliveryFees: 'delivery_fees' as PurposeOfTransactionEnum,
        ServiceCharges: 'service_charges' as PurposeOfTransactionEnum,
        OfficeExpenses: 'office_expenses' as PurposeOfTransactionEnum,
        PropertyPurchase: 'property_purchase' as PurposeOfTransactionEnum,
        PropertyRental: 'property_rental' as PurposeOfTransactionEnum,
        RoyaltyFees: 'royalty_fees' as PurposeOfTransactionEnum,
        SharesInvestment: 'shares_investment' as PurposeOfTransactionEnum,
        FundInvestment: 'fund_investment' as PurposeOfTransactionEnum,
        BillPayment: 'bill_payment' as PurposeOfTransactionEnum,
        TransportationFees: 'transportation_fees' as PurposeOfTransactionEnum,
        SalaryPayment: 'salary_payment' as PurposeOfTransactionEnum,
        RewardPayment: 'reward_payment' as PurposeOfTransactionEnum,
        InfluencerPayment: 'influencer_payment' as PurposeOfTransactionEnum,
        OtherFees: 'other_fees' as PurposeOfTransactionEnum,
        Other: 'other' as PurposeOfTransactionEnum,
        ExportedGoods: 'exported_goods' as PurposeOfTransactionEnum,
        CommissionOnGoods: 'commission_on_goods' as PurposeOfTransactionEnum,
        CommissionOnServices: 'commission_on_services' as PurposeOfTransactionEnum,
        AccountingServices: 'accounting_services' as PurposeOfTransactionEnum,
        ExhibitionServices: 'exhibition_services' as PurposeOfTransactionEnum
    };
}
