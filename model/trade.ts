...
export interface TradeBankModel { 
     ...
     * The type of trade.
     */
    trade_type?: TradeBankModel.TradeTypeEnum;
    /**
     ...
     */
    side?: TradeBankModel.SideEnum;
    /**
     * The trade\'s state
     */
    state?: TradeBankModel.StateEnum;
    /**
...
export namespace TradeBankModel {
    export type TradeTypeEnum = 'platform' | 'liquidation';
