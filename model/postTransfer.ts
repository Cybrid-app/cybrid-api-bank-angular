 ...
 */
import { PostTransferParticipantBankModel } from './postTransferParticipant';
...
export interface PostTransferBankModel { 
     ...
     */
    payment_rail?: PostTransferBankModel.PaymentRailEnum | null;
    /**
     ...
     */
    expected_behaviours?: Array<PostTransferBankModel.ExpectedBehavioursEnum> | null;
    /**
...
export namespace PostTransferBankModel {
    export type TransferTypeEnum = 'funding' | 'crypto' | 'instant_funding' | 'inter_account' | 'lightning' | 'book';
    ...
    export type PaymentRailEnum = 'ach' | 'eft' | 'wire' | 'rtp';
    ...
    export type ExpectedBehavioursEnum = 'force_review';
    export const ExpectedBehavioursEnum = {
        ForceReview: 'force_review' as ExpectedBehavioursEnum
    };
}
