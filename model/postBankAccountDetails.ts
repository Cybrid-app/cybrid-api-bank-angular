...
export namespace PostBankAccountDetailsBankModel {
    export type AccountIdentifierTypeEnum = 'CLABE' | 'PHONE_NUMBER' | 'EMAIL' | 'DEBIT_CARD' | 'CBU' | 'CVU' | 'RANDOM' | 'CPF' | 'CNPJ';
    ...
    export type PaymentRailEnum = 'EFT' | 'ACH' | 'RTP' | 'FEDNOW' | 'WIRE' | 'SPEI' | 'PIX' | 'COELSA' | 'PSE' | 'ETRANSFER' | 'IFSC' | 'SBP' | 'BEFTN' | 'NGBANK' | 'LBTR' | 'SEPA' | 'EASY_PAISA' | 'FINJA' | 'JAZZ_CASH' | 'NAYA_PAY' | 'SADA_PAY' | 'KEBANK' | 'HKBANK' | 'MPESA' | 'CNBANK' | 'FPS' | 'ALIPAY' | 'UNSPECIFIED';
