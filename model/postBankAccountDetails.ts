 ...
 */
export interface PostBankAccountDetailsBankModel { 
    /**
     * The bank code.
     */
    ...
    /**
     * The type of account identifier. Must be VPA for UPI rails, EMAIL or PHONE_NUMBER for Interac e-Transfer rails, and PHONE_NUMBER for mobile wallet rails. Required when payment_rail is UPI, payment_rail is ETRANSFER, payment_rail is EASY_PAISA, payment_rail is FINJA, payment_rail is JAZZ_CASH, payment_rail is NAYA_PAY, payment_rail is SADA_PAY, payment_rail is MPESA, or payment_rail is ALIPAY.
     */
    account_identifier_type?: PostBankAccountDetailsBankModel.AccountIdentifierTypeEnum | null;
    /**
     * The payment rail used for the account.
     */
    payment_rail: PostBankAccountDetailsBankModel.PaymentRailEnum;
    /**
     * The type of bank code. Required when payment_rail is EFT, payment_rail is ACH, payment_rail is RTP, payment_rail is FEDNOW, payment_rail is WIRE, payment_rail is SPEI, payment_rail is PIX, payment_rail is COELSA, payment_rail is PSE, payment_rail is IFSC, payment_rail is SBP, payment_rail is BEFTN, payment_rail is NGBANK, payment_rail is LBTR, payment_rail is SEPA, payment_rail is KEBANK, payment_rail is HKBANK, payment_rail is CNBANK, payment_rail is FPS, or payment_rail is UNSPECIFIED.
     */
    bank_code_type?: PostBankAccountDetailsBankModel.BankCodeTypeEnum | null;
    /**
     ...
     */
    account_type?: PostBankAccountDetailsBankModel.AccountTypeEnum | null;
    /**
     ...
     */
    account_designation?: PostBankAccountDetailsBankModel.AccountDesignationEnum | null;
}
export namespace PostBankAccountDetailsBankModel {
    export type AccountIdentifierTypeEnum = 'CLABE' | 'PHONE_NUMBER' | 'EMAIL' | 'DEBIT_CARD' | 'CBU' | 'CVU' | 'RANDOM' | 'CPF' | 'CNPJ' | 'VPA';
    export const AccountIdentifierTypeEnum = {
        Clabe: 'CLABE' as AccountIdentifierTypeEnum,
        PhoneNumber: 'PHONE_NUMBER' as AccountIdentifierTypeEnum,
        Email: 'EMAIL' as AccountIdentifierTypeEnum,
        DebitCard: 'DEBIT_CARD' as AccountIdentifierTypeEnum,
        Cbu: 'CBU' as AccountIdentifierTypeEnum,
        Cvu: 'CVU' as AccountIdentifierTypeEnum,
        Random: 'RANDOM' as AccountIdentifierTypeEnum,
        Cpf: 'CPF' as AccountIdentifierTypeEnum,
        Cnpj: 'CNPJ' as AccountIdentifierTypeEnum,
        Vpa: 'VPA' as AccountIdentifierTypeEnum
    };
    export type PaymentRailEnum = 'EFT' | 'ACH' | 'RTP' | 'FEDNOW' | 'WIRE' | 'SPEI' | 'PIX' | 'COELSA' | 'PSE' | 'ETRANSFER' | 'IFSC' | 'UPI' | 'SBP' | 'BEFTN' | 'NGBANK' | 'LBTR' | 'SEPA' | 'EASY_PAISA' | 'FINJA' | 'JAZZ_CASH' | 'NAYA_PAY' | 'SADA_PAY' | 'KEBANK' | 'HKBANK' | 'MPESA' | 'CNBANK' | 'FPS' | 'ALIPAY' | 'UNSPECIFIED';
    export const PaymentRailEnum = {
        Eft: 'EFT' as PaymentRailEnum,
        Ach: 'ACH' as PaymentRailEnum,
        Rtp: 'RTP' as PaymentRailEnum,
        Fednow: 'FEDNOW' as PaymentRailEnum,
        Wire: 'WIRE' as PaymentRailEnum,
        Spei: 'SPEI' as PaymentRailEnum,
        Pix: 'PIX' as PaymentRailEnum,
        Coelsa: 'COELSA' as PaymentRailEnum,
        Pse: 'PSE' as PaymentRailEnum,
        Etransfer: 'ETRANSFER' as PaymentRailEnum,
        Ifsc: 'IFSC' as PaymentRailEnum,
        Upi: 'UPI' as PaymentRailEnum,
        Sbp: 'SBP' as PaymentRailEnum,
        Beftn: 'BEFTN' as PaymentRailEnum,
        Ngbank: 'NGBANK' as PaymentRailEnum,
        Lbtr: 'LBTR' as PaymentRailEnum,
        Sepa: 'SEPA' as PaymentRailEnum,
        EasyPaisa: 'EASY_PAISA' as PaymentRailEnum,
        Finja: 'FINJA' as PaymentRailEnum,
        JazzCash: 'JAZZ_CASH' as PaymentRailEnum,
        NayaPay: 'NAYA_PAY' as PaymentRailEnum,
        SadaPay: 'SADA_PAY' as PaymentRailEnum,
        Kebank: 'KEBANK' as PaymentRailEnum,
        Hkbank: 'HKBANK' as PaymentRailEnum,
        Mpesa: 'MPESA' as PaymentRailEnum,
        Cnbank: 'CNBANK' as PaymentRailEnum,
        Fps: 'FPS' as PaymentRailEnum,
        Alipay: 'ALIPAY' as PaymentRailEnum,
        Unspecified: 'UNSPECIFIED' as PaymentRailEnum
    };
    export type BankCodeTypeEnum = 'CPA' | 'ABA' | 'CLABE' | 'PIX' | 'CBU_CVU' | 'PSE' | 'IFSC' | 'IBAN' | 'SBP' | 'BEFTN' | 'SWIFT_BIC' | 'CBN' | 'SORT_CODE';
    export const BankCodeTypeEnum = {
        Cpa: 'CPA' as BankCodeTypeEnum,
        Aba: 'ABA' as BankCodeTypeEnum,
        Clabe: 'CLABE' as BankCodeTypeEnum,
        Pix: 'PIX' as BankCodeTypeEnum,
        CbuCvu: 'CBU_CVU' as BankCodeTypeEnum,
        Pse: 'PSE' as BankCodeTypeEnum,
        Ifsc: 'IFSC' as BankCodeTypeEnum,
        Iban: 'IBAN' as BankCodeTypeEnum,
        Sbp: 'SBP' as BankCodeTypeEnum,
        Beftn: 'BEFTN' as BankCodeTypeEnum,
        SwiftBic: 'SWIFT_BIC' as BankCodeTypeEnum,
        Cbn: 'CBN' as BankCodeTypeEnum,
        SortCode: 'SORT_CODE' as BankCodeTypeEnum
    };
    export type AccountTypeEnum = 'checking' | 'savings';
    export const AccountTypeEnum = {
        Checking: 'checking' as AccountTypeEnum,
        Savings: 'savings' as AccountTypeEnum
    };
    export type AccountDesignationEnum = 'NRE' | 'NRO';
    export const AccountDesignationEnum = {
        Nre: 'NRE' as AccountDesignationEnum,
        Nro: 'NRO' as AccountDesignationEnum
    };
}
