...
export namespace PostIdentityVerificationBankModel {
    ...
    export type MethodEnum = 'watchlists' | 'attested' | 'document_submission' | 'enhanced_due_diligence' | 'id_and_selfie' | 'tax_id_and_selfie' | 'business_registration' | 'attested_id_and_selfie' | 'attested_business_registration' | 'attested_ownership' | 'account_ownership';
