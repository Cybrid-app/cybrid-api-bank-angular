 ...
 */
import { PostIdentityVerificationNameBankModel } from './postIdentityVerificationName';
import { PostIdentityVerificationRegisteredAddressBankModel } from './postIdentityVerificationRegisteredAddress';
import { PostUltimateBeneficialOwnerBankModel } from './postUltimateBeneficialOwner';
import { PostIdentityVerificationAliasesInnerBankModel } from './postIdentityVerificationAliasesInner';
import { PostIdentificationNumberBankModel } from './postIdentificationNumber';
import { PostIdentityVerificationAddressBankModel } from './postIdentityVerificationAddress';
...
export interface PostIdentityVerificationBankModel { 
     ...
     */
    type: PostIdentityVerificationBankModel.TypeEnum;
    /**
     ...
     */
    expected_behaviours?: Array<PostIdentityVerificationBankModel.ExpectedBehavioursEnum> | null;
    /**
     * The identity verification method. Required when type is counterparty, type is kyc, or type is bank_account.
     */
    method?: PostIdentityVerificationBankModel.MethodEnum | null;
    /**
     ...
     */
    aliases?: Array<PostIdentityVerificationAliasesInnerBankModel> | null;
    /**
     ...
     */
    director_customer_guids?: Array<string> | null;
    /**
     ...
     */
    ultimate_beneficial_owners?: Array<PostUltimateBeneficialOwnerBankModel> | null;
    /**
     ...
     */
    supporting_file_guids?: Array<string> | null;
    registered_address?: PostIdentityVerificationRegisteredAddressBankModel | null;
    /**
     ...
     */
    business_industry?: PostIdentityVerificationBankModel.BusinessIndustryEnum | null;
    /**
     ...
     */
    business_type?: PostIdentityVerificationBankModel.BusinessTypeEnum | null;
    /**
...
export namespace PostIdentityVerificationBankModel {
    export type TypeEnum = 'kyc' | 'bank_account' | 'counterparty';
    export const TypeEnum = {
        Kyc: 'kyc' as TypeEnum,
        BankAccount: 'bank_account' as TypeEnum,
        Counterparty: 'counterparty' as TypeEnum
    };
    export type ExpectedBehavioursEnum = 'passed_immediately' | 'failed_immediately' | 'tax_id_not_checked';
    export const ExpectedBehavioursEnum = {
        PassedImmediately: 'passed_immediately' as ExpectedBehavioursEnum,
        FailedImmediately: 'failed_immediately' as ExpectedBehavioursEnum,
        TaxIdNotChecked: 'tax_id_not_checked' as ExpectedBehavioursEnum
    };
    export type MethodEnum = 'watchlists' | 'attested' | 'document_submission' | 'enhanced_due_diligence' | 'id_and_selfie' | 'tax_id_and_selfie' | 'business_registration' | 'attested_id_and_selfie' | 'attested_business_registration' | 'attested_business_associate' | 'attested_id_and_database' | 'attested_ownership' | 'account_ownership';
    export const MethodEnum = {
        Watchlists: 'watchlists' as MethodEnum,
        Attested: 'attested' as MethodEnum,
        DocumentSubmission: 'document_submission' as MethodEnum,
        EnhancedDueDiligence: 'enhanced_due_diligence' as MethodEnum,
        IdAndSelfie: 'id_and_selfie' as MethodEnum,
        TaxIdAndSelfie: 'tax_id_and_selfie' as MethodEnum,
        BusinessRegistration: 'business_registration' as MethodEnum,
        AttestedIdAndSelfie: 'attested_id_and_selfie' as MethodEnum,
        AttestedBusinessRegistration: 'attested_business_registration' as MethodEnum,
        AttestedBusinessAssociate: 'attested_business_associate' as MethodEnum,
        AttestedIdAndDatabase: 'attested_id_and_database' as MethodEnum,
        AttestedOwnership: 'attested_ownership' as MethodEnum,
        AccountOwnership: 'account_ownership' as MethodEnum
    };
    export type BusinessIndustryEnum = 'crypto_digital_assets_blockchain' | 'education' | 'gaming' | 'healthcare_hospitality' | 'lending_investments' | 'logistics_manufacturing_transportation' | 'money_services_payments_remittance' | 'consulting_legal_accounting' | 'real_estate_property_management' | 'retail_ecommerce' | 'social_media_content_creator_influencer' | 'technology_software_saas' | 'wholesale_distribution' | 'other';
    export const BusinessIndustryEnum = {
        CryptoDigitalAssetsBlockchain: 'crypto_digital_assets_blockchain' as BusinessIndustryEnum,
        Education: 'education' as BusinessIndustryEnum,
        Gaming: 'gaming' as BusinessIndustryEnum,
        HealthcareHospitality: 'healthcare_hospitality' as BusinessIndustryEnum,
        LendingInvestments: 'lending_investments' as BusinessIndustryEnum,
        LogisticsManufacturingTransportation: 'logistics_manufacturing_transportation' as BusinessIndustryEnum,
        MoneyServicesPaymentsRemittance: 'money_services_payments_remittance' as BusinessIndustryEnum,
        ConsultingLegalAccounting: 'consulting_legal_accounting' as BusinessIndustryEnum,
        RealEstatePropertyManagement: 'real_estate_property_management' as BusinessIndustryEnum,
        RetailEcommerce: 'retail_ecommerce' as BusinessIndustryEnum,
        SocialMediaContentCreatorInfluencer: 'social_media_content_creator_influencer' as BusinessIndustryEnum,
        TechnologySoftwareSaas: 'technology_software_saas' as BusinessIndustryEnum,
        WholesaleDistribution: 'wholesale_distribution' as BusinessIndustryEnum,
        Other: 'other' as BusinessIndustryEnum
    };
    export type BusinessTypeEnum = 'entity' | 'sole_proprietor';
    export const BusinessTypeEnum = {
        Entity: 'entity' as BusinessTypeEnum,
        SoleProprietor: 'sole_proprietor' as BusinessTypeEnum
    };
}
