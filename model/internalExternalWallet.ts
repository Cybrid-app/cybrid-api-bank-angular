...
export interface InternalExternalWalletBankModel { 
     ...
     * The type of account.
     */
    account_kind?: InternalExternalWalletBankModel.AccountKindEnum;
    /**
     * The environment that the exchange is operating in.
     */
    environment?: InternalExternalWalletBankModel.EnvironmentEnum;
    /**
     ...
     */
    state?: InternalExternalWalletBankModel.StateEnum;
    /**
     * The failure code of an external wallet (if any)
     */
    failure_code?: string | null;
}
export namespace InternalExternalWalletBankModel {
    ...
    export type StateEnum = 'storing' | 'pending' | 'failed' | 'completed' | 'deleting' | 'deleted';
