...
export interface ExchangeBankModel { 
     ...
     */
    provider?: ExchangeBankModel.ProviderEnum;
    /**
     * The environment that the exchange is operating in.
     */
    environment?: ExchangeBankModel.EnvironmentEnum;
    /**
     * ISO8601 datetime the exchange was created at.
     */
    created_at?: string;
}
export namespace ExchangeBankModel {
    export type ProviderEnum = 'aquanow' | 'dv_chain';
    export const ProviderEnum = {
        Aquanow: 'aquanow' as ProviderEnum,
        DvChain: 'dv_chain' as ProviderEnum
    };
