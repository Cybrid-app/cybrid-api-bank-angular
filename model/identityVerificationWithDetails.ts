 ...
 */
import { IdentityVerificationWithDetailsAllOfBankModel } from './identityVerificationWithDetailsAllOf';
import { IdentityVerificationBankModel } from './identityVerification';
...
export interface IdentityVerificationWithDetailsBankModel { 
     ...
     */
    type?: IdentityVerificationWithDetailsBankModel.TypeEnum;
    /**
     * The identity verification method.
     */
    method?: IdentityVerificationWithDetailsBankModel.MethodEnum;
    /**
     ...
     */
    state?: IdentityVerificationWithDetailsBankModel.StateEnum;
    /**
     * The outcome of the verification process.
     */
    outcome?: IdentityVerificationWithDetailsBankModel.OutcomeEnum | null;
    /**
     * The reason codes explaining the outcome.
     */
    failure_codes?: Array<IdentityVerificationWithDetailsBankModel.FailureCodesEnum>;
    /**
     ...
     */
    persona_state?: IdentityVerificationWithDetailsBankModel.PersonaStateEnum | null;
    /**
     * The external bank account\'s identifier.
     */
    external_bank_account_guid?: string | null;
}
export namespace IdentityVerificationWithDetailsBankModel {
    export type TypeEnum = 'kyc' | 'bank_account';
    export const TypeEnum = {
        Kyc: 'kyc' as TypeEnum,
        BankAccount: 'bank_account' as TypeEnum
    };
    export type MethodEnum = 'id_and_selfie' | 'attested' | 'plaid_identity_match';
    export const MethodEnum = {
        IdAndSelfie: 'id_and_selfie' as MethodEnum,
        Attested: 'attested' as MethodEnum,
        PlaidIdentityMatch: 'plaid_identity_match' as MethodEnum
    };
    ...
    export const PersonaStateEnum = {
        Waiting: 'waiting' as PersonaStateEnum,
        Pending: 'pending' as PersonaStateEnum,
        Reviewing: 'reviewing' as PersonaStateEnum,
        Processing: 'processing' as PersonaStateEnum,
        Expired: 'expired' as PersonaStateEnum,
        Completed: 'completed' as PersonaStateEnum,
        Unknown: 'unknown' as PersonaStateEnum
    };
}
