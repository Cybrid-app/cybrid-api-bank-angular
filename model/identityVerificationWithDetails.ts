...
export namespace IdentityVerificationWithDetailsBankModel {
    ...
    export type FailureCodesEnum = 'requested_failure' | 'id_check_failure' | 'database_check_failure' | 'selfie_failure' | 'pep_check_failure' | 'watchlist_check_failure' | 'name_check_failure' | 'address_check_failure' | 'dob_check_failure' | 'id_number_check_failure' | 'phone_number_check_failure' | 'email_address_check_failure' | 'decision_timeout' | 'plaid_failure';
