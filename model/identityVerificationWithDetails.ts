...
export namespace IdentityVerificationWithDetailsBankModel {
    ...
    export type MethodEnum = 'id_and_selfie';
    ...
    export type FailureCodesEnum = 'requested_failure' | 'id_check_failure' | 'database_check_failure' | 'selfie_failure' | 'pep_check_failure' | 'watchlist_check_failure';
