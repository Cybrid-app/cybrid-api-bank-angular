 ...
 */
import { InternalExternalBankAccountPiiInnerBankModel } from './internalExternalBankAccountPiiInner';
import { ExternalBankAccountBalancesBankModel } from './externalBankAccountBalances';


export interface InternalExternalBankAccountBankModel { 
    /**
     ...
     * The type of account.
     */
    account_kind?: InternalExternalBankAccountBankModel.AccountKindEnum;
    /**
     * The environment that the external bank account is operating in.
     */
    environment?: InternalExternalBankAccountBankModel.EnvironmentEnum;
    /**
     * The bank identifier.
     */
     ...
     */
    state?: InternalExternalBankAccountBankModel.StateEnum;
    /**
     ...
     */
    pii?: Array<InternalExternalBankAccountPiiInnerBankModel> | null;
}
export namespace InternalExternalBankAccountBankModel {
    export type AccountKindEnum = 'modern_treasury_external_account' | 'plaid' | 'plaid_processor_token' | 'raw_routing_details';
    export const AccountKindEnum = {
        ModernTreasuryExternalAccount: 'modern_treasury_external_account' as AccountKindEnum,
        Plaid: 'plaid' as AccountKindEnum,
        PlaidProcessorToken: 'plaid_processor_token' as AccountKindEnum,
        RawRoutingDetails: 'raw_routing_details' as AccountKindEnum
    };
    ...
    export type StateEnum = 'storing' | 'completed' | 'failed' | 'refresh_required' | 'unverified' | 'deleting' | 'deleted';
