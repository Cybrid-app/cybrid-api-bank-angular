 ...
 */
import { InternalTransferDestinationAccountBankModel } from './internalTransferDestinationAccount';
import { TransferParticipantBankModel } from './transferParticipant';
import { InternalTransferSourceAccountBankModel } from './internalTransferSourceAccount';
...
export interface InternalTransferBankModel { 
     ...
     */
    transfer_type?: InternalTransferBankModel.TransferTypeEnum;
    /**
     ...
     */
    side?: InternalTransferBankModel.SideEnum;
    /**
     * The transfer\'s state
     */
    state?: InternalTransferBankModel.StateEnum;
    /**
...
export namespace InternalTransferBankModel {
    export type TransferTypeEnum = 'funding' | 'book' | 'crypto' | 'internal_bank_rebalance' | 'internal_wallet_rebalance' | 'instant_funding' | 'funding_return' | 'crypto_return' | 'loss_recovery' | 'inter_account' | 'lightning' | 'instant_funding_return';
    export const TransferTypeEnum = {
        ...
        LossRecovery: 'loss_recovery' as TransferTypeEnum,
        InterAccount: 'inter_account' as TransferTypeEnum,
        Lightning: 'lightning' as TransferTypeEnum,
        InstantFundingReturn: 'instant_funding_return' as TransferTypeEnum
    };
    ...
    export type StateEnum = 'storing' | 'pending' | 'reviewing' | 'completed' | 'failed' | 'holding';
