 ...
 */
export interface InternalExchangeOrderBankModel { 
    /**
     * The platform environment.
     */
    environment: InternalExchangeOrderBankModel.EnvironmentEnum;
    /**
     ...
     */
    type: InternalExchangeOrderBankModel.TypeEnum;
    /**
    ...
    /**
     * The set of included trade guids.
     */
    trade_guids: Array<string>;
    /**
     * The symbol code representing the trading pair.
     */
    symbol: string;
    /**
     * The direction for order.
     */
    side: InternalExchangeOrderBankModel.SideEnum;
    /**
     * The deliver amount asset code.
     */
    deliver_asset: string;
    /**
     * The receive amount asset code.
     */
    receive_asset: string;
    /**
     * The requested deliver amount in cents.
     */
    requested_deliver_amount: string;
    /**
     * The requested receive amount in cents.
     */
    requested_receive_amount: string;
    /**
     * The executed deliver amount in cents.
     */
    executed_deliver_amount?: string | null;
    /**
     * The executed receive amount in cents.
     */
    executed_receive_amount?: string | null;
    /**
     * The unassigned deliver amount in cents.
     */
    unassigned_deliver_amount?: string | null;
    /**
     * The unassigned receive amount in cents.
     */
    unassigned_receive_amount?: string | null;
    /**
     * The source payable account identifier.
     */
    source_payable_account_guid: string;
    /**
     * The destination payable account identifier.
     */
    destination_payable_account_guid: string;
    /**
     * The source receivable account identifier.
     */
    source_receivable_account_guid: string;
    /**
     * The destination receivable account identifier.
     */
    destination_receivable_account_guid: string;
    /**
     * The state of the entity.
     */
    state: InternalExchangeOrderBankModel.StateEnum;
    /**
     * The failure code if the entity is in a failed state.
     */
    failure_code?: InternalExchangeOrderBankModel.FailureCodeEnum | null;
}
export namespace InternalExchangeOrderBankModel {
    ...
    export type FailureCodeEnum = 'non_sufficient_funds' | 'not_filled';
    export const FailureCodeEnum = {
        NonSufficientFunds: 'non_sufficient_funds' as FailureCodeEnum,
        NotFilled: 'not_filled' as FailureCodeEnum
    };
}
